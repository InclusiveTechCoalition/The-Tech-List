<template>
    <v-container>
        <h1>Add a new list member</h1>
        <v-form v-model="valid">
            <v-container>
                <v-row>
                  <v-col><v-text-field v-model="full_name" label="Full Name" required/></v-col>
                  <v-col>
                ...
                <v-row>
                  ...
                  <v-col>
                    <v-text-field v-model="pronouns.subject" label="he/she/they" :value="pronouns.subject" required/>
                  </v-col>
                  <v-col>
                ...
                <v-row>
                    <v-textarea v-model="description" :label="`What makes ${pronouns.object ? pronouns.object : 'them'} notable?`" required></v-textarea>
                </v-row>
              <v-row>
